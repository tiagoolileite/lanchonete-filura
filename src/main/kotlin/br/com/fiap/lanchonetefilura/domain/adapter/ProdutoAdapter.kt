...
interface ProdutoAdapter {
    ...
    fun adaptarProdutosDtoParaDomainDtoImpl(produtosDTO : List<ProdutoDTO>): List<ProdutoDomainDTOImpl>
    ...
    fun adaptarProdutosDomainDtoParaProdutos(produtosDomainDTO : List<ProdutoDomainDTO>) : List<Produto>

    fun adaptarProdutosParaProdutosDomainDto(produtos : List<Produto>) : List<ProdutoDomainDTOImpl>
}
